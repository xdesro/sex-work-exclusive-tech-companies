...
* Open an Issue at https://github.com/xdesro/sex-work-exclusive-tech-companies#readme/issues
...
## Contribute Documentation and Content

Documentation and content are a super important, critical part of this project. Docs are how we keep track of what we're doing, how, and why. It's how we stay on the same page about our policies. And it's how we tell others everything they need in order to be able to use this project -- or contribute to it. So thank you in advance. 
...
* Go to https://github.com/xdesro/sex-work-exclusive-tech-companies/pulls and open a new pull request with your changes.
...
* Go to https://github.com/xdesro/sex-work-exclusive-tech-companies#readme/pulls and open a new pull request with your changes.
* If your PR is connected to an open issue, add a line in your PR's description that says `Fixes: #123`, where `#123` is the number of the issue you're fixing.
...
* Go to the issue tracker and [filter open issues by the `support` label](https://github.com/xdesro/sex-work-exclusive-tech-companies#readme/issues?q=is%3Aopen+is%3Aissue+label%3Asupport).
...
In order to label issues, [open up the list of unlabeled issues](https://github.com/xdesro/sex-work-exclusive-tech-companies#readme/issues?q=is%3Aopen+is%3Aissue+no%3Alabel) and, **from newest to oldest**, read through each one and apply issue labels according to the table below. If you're unsure about what label to apply, skip the issue and try the next one: don't feel obligated to label each and every issue yourself!
...
* Leave a message when closing saying "Cleaning up stale issue. Please reopen or ping us if and when you're ready to resume this. See https://github.com/xdesro/sex-work-exclusive-tech-companies#readme/blob/latest/CONTRIBUTING.md#clean-up-issues-and-prs for more details."
